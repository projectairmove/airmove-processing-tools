...
storage=$DOWNLOAD_DIR/05-S5P_NO2_AND_SO2
...
conda run -n $PROCESSING_ENV python $PROCESSING_SCRIPTS_DIR/download_s5p_no2.py --log-dir $today_log --from-date $from_date --to-date $to_date
